...
export function buildTourHtml(tour) {
...
<style>
  * { box-sizing: border-box; }
  ...
  .title-card { position: absolute; top: 18px; left: 18px; z-index: 10;
  ...
  .controls { position: absolute; left: 50%; bottom: 22px; transform: translateX(-50%); z-index: 10;
