...
leads = [
    ...
    ["Carlsen Verlag GmbH",
     "Mediengestalter:in / Mediendesign (Digital & Print)",
     "Gestaltung/Reinzeichnung von Buch-, Marketing- und Digitalmedien; teils Homeoffice moeglich.",
     "Ausbildung/Studium Mediengestaltung/Kommunikationsdesign; Adobe InDesign/Photoshop/Illustrator.",
     "Buchverlag (Kinder-/Jugendbuch, Comics/Manga; Bonnier-Gruppe). Sitz Ottensen.",
     "laufend 2026",
     "Verlag stellt lfd. ein, teils befristet",
     "Bewerbung ueber Karriereportal",
     "ueber carlsen.de/karriere",
     "+49 40 39804-0",
     "Voelckersstr. 14-20, 22765 Hamburg-Ottensen",
     "www.carlsen.de",
     "StepStone / dasauge"],

    ["HINSCHE Gastrowelt GmbH",
     "Mediengestalter (m/w/d) Digital und Print",
     "Konzeption/Gestaltung von Print- & Werbematerialien (Flyer, Kataloge, Anzeigen, Plakate, Geschaeftsausstattung); Support Digital & Social Media.",
     "Ausbildung Mediengestalter Digital und Print; Adobe Creative Suite.",
     "Gastro-Gesamtausstatter (Gastronomie/Hotellerie/Grosskueche, >85 J.). Standort Hamburg; HR-Sitz Oldenburg.",
     "laufend 2026",
     "Standort HH, Recruiting ueber Zentrale",
     "Sebastian Pozo (Personalabteilung)",
     "bewerbung@hinsche-gastrowelt.de",
     "+49 441 9355-234",
     "Standort Hamburg; HR: Wilhelmshavener Heerstr. 65, 26125 Oldenburg",
     "www.hinsche-gastrowelt.de",
     "hamburger.jobs / heyjobs"],

    ["Saint Elmo's Hamburg GmbH & Co. KG",
     "Mediengestalter / Reinzeichner (all genders)",
     "Reinzeichnung/Gestaltung fuer Print & Digital in einer Kreativ-/Werbeagentur.",
     "Ausbildung Mediengestalter/Reinzeichner; sicher in Adobe.",
     "Kreativ-/Werbeagentur (Saint Elmo's Group). GF Peter Gocht (HRA 118172).",
     "laufend 2026",
     "Agentur, laufend im Recruiting",
     "Peter Gocht (Managing Director)",
     "ueber saint-elmos.com (Impressum)",
     "+49 40 2022888302",
     "Steinhoeft 9, 20459 Hamburg",
     "www.saint-elmos.com",
     "Indeed / trabajo.org"],

    ["fischerAppelt AG",
     "Mediengestalter:in / Grafiker:in (m/w/d)",
     "Gestaltung/Reinzeichnung fuer Content-, PR- und Digitalprojekte.",
     "Ausbildung/Studium Grafik/Mediengestaltung; Adobe; crossmediales Arbeiten.",
     "Fuehrende Content-Marketing- & PR-Agenturgruppe. Vorstand B. & A. Fischer-Appelt (HRB 77749).",
     "laufend 2026",
     "grosse Agentur, mehrere Kreativ-Rollen offen",
     "kein Name genannt",
     "info@fischerappelt.de",
     "+49 40 899699-0",
     "Waterloohain 5, 22769 Hamburg-Eimsbuettel",
     "www.fischerappelt.com",
     "dasauge / trabajo.org"],

    ["Mutabor Design GmbH",
     "Mediengestalter:in / Grafiker:in (m/w/d)",
     "Gestaltung/Umsetzung von Markenauftritten (Brand Design, Kampagnen, Retail/Environmental).",
     "Ausbildung/Studium Grafik-/Kommunikationsdesign; Adobe CC.",
     "Renommierte Markenagentur (Strategy, Design & Technology). GF Paravicini, Plass, Breid (HRB 81512).",
     "laufend 2026",
     "renommierte Agentur, lfd. Designbedarf",
     "kein Name genannt",
     "ueber mutabor.com/contact",
     "040 39922410",
     "Grosse Elbstrasse 145b, 22767 Hamburg-Altona",
     "www.mutabor.com",
     "dasauge / designmadeingermany"],

    ["TOM TAILOR GmbH",
     "(Junior/Senior) Graphic Designer (m/w/d)",
     "Erstellung CI-basierter Online- & Print-Assets; Plakate, Inlays, Anzeigen; Praesentationen & Guidelines. Hybrid.",
     "Ausbildung/Studium Grafik/Mediengestaltung; Adobe; Fashion-/Brand-Affinitaet.",
     "Casual-Fashion- & Lifestyle-Marke. Sitz Hamburg (Norderstedt/Garstedter Weg).",
     "laufend 2026",
     "Junior UND Senior parallel gesucht",
     "Bewerbung ueber Stellenmarkt (tom-tailor.de)",
     "info@tom-tailor.com",
     "+49 40 58956-0",
     "Garstedter Weg 14, 22453 Hamburg",
     "company.tom-tailor.com",
     "tom-tailor.de / trabajo.org"],

    ["UNGER GmbH & Co. KG (UNGER Fashion)",
     "Kommunikationsdesigner (m/w/d), Voll-/Teilzeit",
     "Grafik, Reinzeichnung, Design fuer Store & Onlineshop; Qualitaetskontrolle der Darstellung.",
     "Ausbildung/Studium Grafik/Kommunikationsdesign; Adobe; E-Commerce-Affinitaet.",
     "Luxus-Mode: Store am Neuer Wall + internationaler Onlineshop (>150 Marken, >140 J.). GF Florian Braun.",
     "laufend 2026",
     "breites Profil (Grafik + Reinzeichnung + QA)",
     "kein Name genannt",
     "ueber unger-fashion.com/kontakt",
     "s. Website",
